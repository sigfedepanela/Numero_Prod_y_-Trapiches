...
var style_NmerodeProductoresdePanela_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Total.Prod");
    var labelText = "";
    size = 0;
    ...
    if (value > 349.000000 && value <= 2356.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2356.800000 && value <= 4364.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 4364.600000 && value <= 6372.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 6372.400000 && value <= 8380.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 8380.200000 && value <= 10388.000000) {
            style = [ new ol.style.Style({
